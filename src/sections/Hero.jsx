...
const Hero = () => {
  return (
    <section className=" min-h-screen flex flex-col lg:flex-row items-center justify-center lg:justify-between px-6 md:px-12 bg-white dark:bg-[#0F172A] transition-colors duration-300 overflow-hidden">
      {/* LEFT CONTENT */}
      <div className="container mx-auto  flex flex-col lg:flex-row items-center justify-center lg:justify-between px-6 md:px-12 lg:px-24">
        <motion.div initial={{ opacity: 0, x: -60 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1, ease: "easeOut" }} className="max-w-xl text-center lg:text-left space-y-6">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-base md:text-lg leading-relaxed">
            Saya seorang pengembang web dengan fokus pada teknologi modern. Dengan keahlian di bidang <span className="text-teal-500">React</span> untuk frontend dan <span className="text-blue-500">Node.js, Express.js, PHP, Laravel</span>{" "}
            untuk backend, saya menghadirkan kombinasi keterampilan teknis dan solusi kreatif di setiap proyek.
          </p>
          <div>
            {/* Tombol Download CV */}
            <a
              href={CV}
              download="Rebly-Megib-Tabuni-CV.pdf"
              className="inline-block px-6 py-3 text-white font-semibold bg-gradient-to-r from-teal-500 to-blue-500 rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300"
            >
              Unduh CV Saya
            </a>
          </div>
